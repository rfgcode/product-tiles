...
export default function ProductCard({
  ...
  // icon reveal (fade only, no growing) + product photo swap
  useEffect(() => {
    ...
    gsap.set(imageFrontRef.current, { opacity: showChrome ? 0 : 1 });
    gsap.set(imageBackRef.current, { opacity: showChrome ? 1 : 0 });
