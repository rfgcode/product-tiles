...
import styles from "./ProductCardCompareSaveCta.module.css";
...
// Version 3's "Desktop Compare & Save + CTA" tile: a straight duplicate of
// ProductCardCompareSave (same Compare/Save action bar, same numbered
// selection badge, same hover behavior) with one addition per the Figma
// spec — a full-width "Request quote" button below the price. The page only
// ever renders three of these, one per row (see the `compare-save-cta`
// branch in app/page.tsx), rather than the tripled grid the other V3 tabs
// use. V1 and V2 are untouched.
export default function ProductCardCompareSaveCta({
  variant = 0,
  isComparing = false,
  compareNumber,
  onToggleCompare,
